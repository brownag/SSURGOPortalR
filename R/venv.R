...
#' @param version _character_. Semantic version number of 'Python' to install if not available. Default: `"3.10:latest"`, the latest version of Python 3.10.x.
...
#' @export
create_ssurgo_venv <- function(envname = "r-ssurgoportal", version = "3.10:latest", gdal_version = "3.7.3") {
  if (!.has_reticulate()) {
